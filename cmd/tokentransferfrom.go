...
var tokenTransferFromCmd = &cobra.Command{
    ...
    gramreal token transferfrom --token=omg --from=0x5FfC014343cd971B7eb70732021E26C35B744cc4 --to=0x52f1A3027d3aA514F17E454C93ae1F79b3B12d5d --by= --amount=10 --passphrase=secret
