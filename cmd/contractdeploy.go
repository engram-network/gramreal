...
var contractDeployCmd = &cobra.Command{
   ...
   gramreal contract deploy --data=0x606060...430029 --from=0x5FfC014343cd971B7eb70732021E26C35B744cc4 --passphrase=secret
...
where data is the hex string of the contract binary.  If the contract constructor requires arguments the both the ABI and the constructor are required, for example:
   ...
   gramreal contract deploy --data=0x606060...430029 --abi='./MyContract.abi' --constructor='constructor(1,2,3)' --from=0x5FfC014343cd971B7eb70732021E26C35B744cc4 --passphrase=secret
...
Usually the easiest way to deploy a contract is to use the combined JSON output of solc.  In this situation deploying the contract might be:
   ...
   gramreal contract deploy --json='./MyContract.json' --constructor='constructor(1,2,3') --from=0x5FfC014343cd971B7eb70732021E26C35B744cc4 --passphrase=secret
